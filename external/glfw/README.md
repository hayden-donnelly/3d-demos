(NOTICE) This version of GLFW has been modified with the X11 patch from nixpkgs:
```cmake
target_link_libraries(glfw PRIVATE ${X11_Xrandr_LIB}
                                   ...
                                   ${X11_Xshape_LIB})
```
Ref: https://github.com/NixOS/nixpkgs/blob/c3d4ac725177c030b1e289015989da2ad9d56af0/pkgs/development/libraries/glfw/x11.patch
